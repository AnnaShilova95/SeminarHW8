...
Console.WriteLine("Элементы массива от 1 до ");
...
//Функция упорядочивания элементов
...
{
  int variableSumLine = SumElements(array, i);
...
//Функция поиска суммы элементов строк
...
while (variable <= squareArray.GetLength(0) * squareArray.GetLength(1))
{
  squareArray[i, j] = variable;
  variable++;
